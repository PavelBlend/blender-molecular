...
values = {
    ...
    'link_tension': (1.0, 0.0, FLOAT_MAX),
    'link_tension_mode': 'CONSTANT',
    'link_tensionrand': (0.0, 0.0, 1.0),
    'link_tensiontex': '',
    'link_tensiontex_coeff': (1.0, FLOAT_MIN, FLOAT_MAX),
    'links_active': False,
    'matter': -1,
    ...
    'relink_tension': (1.0, 0.0, FLOAT_MAX),
    'relink_tension_mode': 'CONSTANT',
    'relink_tensionrand': (0.0, 0.0, 1.0),
    'relink_tensiontex': '',
    'relink_tensiontex_coeff': (1.0, FLOAT_MIN, FLOAT_MAX),
